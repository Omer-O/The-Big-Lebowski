...
app.use(
  cookieSession({
    //this code create a session with the cookie.
...
app.post("/profile", (req, res) => {
  db.addUserProfile(
    ...
    .then(rslt => {
      console.log('result of POST: addUserProfile', rslt);
...
app.post("/petition", (req, res) => {
  db.addSignature(req.body.signature, req.session.userId)
    .then(rslt => {
      console.log("this is result of addSignature:", rslt);
...
app.get("/petition/signed", (req, res) => {
  ...
  db.getSignature(req.session.userId).then(rslt => {
    // console.log("this is the getSignature results:", rslt);
    db.getUserSignedCount()
      .then(results => {
...
app.get("/petition/signers", (req, res) => {
  // console.log('this is req.body of signers', req.body)
  db.signers()
    .then(signer => {
      // console.log("loging name after singers:", signer);
      res.render("signers", {
        layout: "main",
        siteName: "The DUDE Day",
        signers: signer.rows,
